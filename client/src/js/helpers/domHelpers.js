...
export function createCheckoutForm(product, changeSizeHandler, changeToppingHandler, sendOrder) {
  ...
  createElement('p', product.name, {id:'product_name'}, null, '#modal_details');
...
export function updateProductPrice(newPrice) {
  document.querySelector('#modal_price').innerHTML = '';
  createElement('span', `UAH ${newPrice}`, {id:'total_price'}, null, '#modal_price');
}